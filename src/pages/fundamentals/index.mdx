---
title: Fundamentals
description: overview and implications of designing for AI
---
...
<AnchorLinks>
  ...
  <AnchorLink>Characteristics of AI</AnchorLink>
  <AnchorLink>Design factors for AI</AnchorLink>
  <AnchorLink>Relationship development</AnchorLink>
...
![Four column chart. The first three are the Transaction Age, spanning from the 1950s until to 2000s. The last column is The Relationship Era, taking place from the 2000s until the 2020s](../../images/fundamentals/Image_1.png)
...
<Caption fullWidth>
  Establishing a human/machine relationship
</Caption>
</Column>
</Row>
