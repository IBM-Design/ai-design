...
<Column className={'show-on-small'} colSm={2} offsetSm={1} colMd={2} colLg={3} offsetLg={1}>
...
<Column className={'hide-on-small'} colSm={2} offsetSm={1} colMd={2} colLg={3} offsetLg={1}>
