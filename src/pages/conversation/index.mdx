...
For example, in the utterance: “I’d like to order some tacos and beer,” the intent would be *order meal*. In the utterance: “Where is the bathroom?” the intent is *locate*.
