...
description: steps to take to make better a chatbot
---
...
<AnchorLinks>
  ...
  <AnchorLink href={"#"}>Conclusion</AnchorLink>
</AnchorLinks>

## Introduction
According to a [Forrester study](https://go.forrester.com/blogs/17-05-29-chatbots_are_transforming_marketing/), most chatbot failures have three things in common. Their creators:

- don't clearly define their purpose
- set goals that are too ambitious
- launch before they're ready

The crux of the problem is not rooted in the technology; it's a lack of planning. By aligning on the intent for what a chatbot can do for your users, you drastically increase the likelihood of success — and save time, effort, and money in the process.

## Establish its purpose
Now that we've introduced the core concepts of bots and conversation, it’s time to start preparing for the actual building. Using the concepts from the learning phase, you will be developing a plan *before* sitting down in your tooling to write content.
...
There are two steps to achieving your MVK: 
1. Determining which topics are needed. 
2. Specifying the depth of each topic to be covered.
...
Each topic will require you to not only to design all possible ideal paths, but all possible failure states for when the bot fails to understand the user. In the moments where the user has strayed outside of your bot’s capabilities, irritation and frustration can naturally follow. The ability to elegantly fail and then repair the conversation is paramount for displaying provable authenticity and building trust.

At this step, start with a topic and flesh out the individual turns between the human and bot until it reaches a dead end. It helps to start with the ideal path(s), and from there branch off into all of the possible ways mistakes or deviations can be made along the way.
...
Personality follows the MVK, because solving the user’s need is the first priority. Also, without all of the proper planning, you will be ill-prepared to identify the proper personality for your bot. Since a bot’s personality will be the "being" that the user will interact with in the end product, it needs to properly reflect the conversational tendencies of its particular domain.
...
There are lots of different ways to come up with a personality, and all of them are correct. You might consider thinking about personality mapping techniques including the [DiSC Profile] (https://www.discprofile.com/resources-and-tools/sample-reports/) or the [Myers & Briggs Type Indicator] (https://www.myersbriggs.org/type-use-for-everyday-life/personality-and-careers/).
...
Even though this is discussed linearly, this isn’t an inherently linear process. You can revisit any previous step at any time as you learn more through your research and experimentation. Just ensure to research and validate often and iterate iterate iterate! Read more about moving through [The Loop](https://www.ibm.com/design/thinking/page/framework/loop) on the [Enterprise Design Thinking](https://www.ibm.com/design/thinking/) site.
