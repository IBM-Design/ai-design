...
import { AnchorLink, AnchorLinks, Column, PageDescription, ResourceCard, Row } from "gatsby-theme-carbon";
...
<AnchorLinks small={true}>
  ...
  <AnchorLink href={"#"}>Chatbots & Conversational Agents</AnchorLink>
  <AnchorLink href={"#"}>Chatbot & Agent Uses</AnchorLink>
  <AnchorLink href={"#"}>What is Conversation?</AnchorLink>
  <AnchorLink href={"#"}>Crafting Effective Conversation</AnchorLink>
  <AnchorLink href={"#"}>How does a bot interpret conversation?</AnchorLink>
</AnchorLinks>

<Row>
<Column noGutterSm={true} colSm={2} colMd={3} colLg={4}>
<ResourceCard
  href={'ibm.com'}
  subTitle={'Subtitle'}
  title={'Title'} />
...
Mastering a differentiated chatbot and conversational agent design provides an opportunity for IBM to use the breadth and depth of its tech expertise as the launchpad for unique, branded conversations between an intelligent machine and an unpredictable human, with complex, emotional needs.

# Chatbots and Conversational Agents
For the sake of simplicity, we will be referring to both chatbots and conversational agents as “bots” for the rest of this guide. Successful bots must augment capabilities and expertise, while also being an extension of the brands they represent. Bots have some clear uses including:
